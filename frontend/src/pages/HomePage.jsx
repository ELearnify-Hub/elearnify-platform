        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {FEATURES.map(({ icon, title, desc }) => (
              <div key={title} className="text-center p-6 rounded-xl bg-gray-50 hover:bg-blue-50 transition-colors">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {CATEGORIES.map(cat => (
              <Link
                ...
                className="bg-white border border-gray-200 hover:border-blue-400 hover:text-blue-600 text-gray-700 px-5 py-2.5 rounded-full shadow-sm transition-all text-sm font-medium">
                {cat}
              </Link>
            ))}
          </div>
