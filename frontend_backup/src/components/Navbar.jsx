      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {menuOpen && (
          <div className="md:hidden pb-4 flex flex-col gap-3">
            <Link to="/"        onClick={() => setMenuOpen(false)} className="text-blue-100 hover:text-white py-1">Home</Link>
            <Link to="/courses" onClick={() => setMenuOpen(false)} className="text-blue-100 hover:text-white py-1">Courses</Link>

            {isLoggedIn && !isAdmin && (
              <Link to="/my-courses" onClick={() => setMenuOpen(false)} className="text-blue-100 hover:text-white py-1">
                My Learning
              </Link>
            )}
            {isAdmin && (
              <Link to="/admin" onClick={() => setMenuOpen(false)} className="text-blue-100 hover:text-white py-1">
                Dashboard
              </Link>
            )}
            ...
            <div className="pt-2 border-t border-blue-600">
              {!isLoggedIn ? (
                <div className="flex gap-3">
                  ...
                  <Link to="/register" onClick={() => setMenuOpen(false)} className="text-blue-100 hover:text-white">Register</Link>
                </div>
              ) : (
